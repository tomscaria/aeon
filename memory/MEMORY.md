...
- `memory/topics/papers.md` — **05-10 daily slot: Signal Credibility Index (`2604.27041`, Nechepurenko, Apr 29 2026, econ.GN cross-list, 19pp / logit-persistence + Cobb-Douglas concentration weight + time-varying per-tick spec / two pre-specified failure modes — concrete CalibrationGap per-tick scanner-gate, price-move-credibility axis complement to the now-fully-picked 3-paper Nechepurenko ILS arc, ADR seed for `ADR-???-sci-entry-gate` ahead of ADR-096+)**; 05-09 daily slot: ForesightFlow (`2605.00493`, foundational ILS-framework paper / Murphy-decomposition link / 24-insider-case inventory / 0.444-magnitude article-vs-automated sign-reversal / Mann-Whitney p=1e-6 standard-proxy failure); 05-08 PhD slot: AEL (`2604.21725`, two-timescale Thompson-sampling retrieval-policy bandit + LLM-reflection causal-insight injection, Sharpe 2.13±0.47, ADR seed for Aeon retrieval-policy-bandit); 05-08 daily slot: Per-Market ILS (`2605.02287`, 210k wallet-market pairs / 3.14% skilled / 1,950 insider-flagged). Next-PhD-slot lead: Heterogeneous Scientific Foundation Model Collaboration (`2604.27351`, ↑118, UIUC). Next-daily-slot lead: Information Aggregation with AI Agents (`2604.20050`, Galanis, Apr 21 2026, econ.GN/cs.MA).
...
- **`paper-pick` next slots** → PhD: **Heterogeneous Scientific Foundation Model Collaboration (`2604.27351`, ↑118, UIUC)** — promoted 05-08; backstop EvoScientist (`2603.08127`, ↑14). Daily: **Information Aggregation with AI Agents (`2604.20050`, Spyros Galanis, Apr 21 2026, econ.GN/cs.MA)** — promoted 05-10 after Signal Credibility Index picked same day daily slot; controlled experiment on LLM aggregation through trading (effective on easy tasks, struggles on complex reasoning); pairs with Coordination Layer architectural-axis cite. Backstop: Interest-Bearing Long-Horizon (`2602.21091`, Maresca, econ.GN) for the Russia-Ukraine EoY-2026 long-horizon hook.
- **Cite stack for next grant / Stanford application** — Cong (`2604.20421`, Stanford anchor) + PolySwarm + Anatomy + Foresight Arena + **ForesightFlow (`2605.00493`, foundational ILS framework)** + ILS-dl Iran-cluster (`2605.02286`, empirical anchor) + Per-Market ILS (`2605.02287`, methodology formalization) + **SCI (`2604.27041`, price-move-credibility axis, econ.GN cross-list, two failure modes pre-specified)** + Coordination Layer + TimeSeek + Prediction Arena (head-to-head: grok-4-20 71.4% PM vs CalibrationGap 76%/29) + AEL (`2604.21725`, Sharpe 2.13) + LBS-Yale 1.72M-account/3.14%-informed + Deflated Sharpe Ratio. **3-paper Nechepurenko ILS arc now fully operator-citable** (framework + population-evaluation + Iran-empirical) **+ SCI as price-move-credibility complement** = 4-paper Nechepurenko microstructure-and-credibility stack.
