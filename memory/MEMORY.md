...
- `memory/topics/papers.md` — **05-11 daily slot: Information Aggregation with AI Agents (`2604.20050`, Galanis, Apr 21 2026 v1 / May 7 2026 v2, econ.GN primary + cs.AI + cs.GT, 64pp single-author / controlled prediction-market experiment with AI agents on private signals / 5-claim stack: median market aggregates effectively on easy structures + complexity degrades aggregation + robust to cheap-talk/duration/initial-price/strategic-prompting + smarter agents aggregate better + past-performance feedback null result / first single-paper-econ.GN-primary cite in operator's bench / 2-paper-in-48h q-fin.TR→econ.GN tilt with SCI / experimental falsifier for CalibrationGap Bayesian-fusion stage + signals ADR-096+ from aggregation axis)**; 05-10 daily slot: Signal Credibility Index (`2604.27041`, Nechepurenko, Apr 29 2026, econ.GN cross-list, logit-persistence + Cobb-Douglas concentration + time-varying per-tick spec + two pre-specified failure modes); 05-09 daily slot: ForesightFlow (`2605.00493`, foundational ILS framework / Murphy-decomposition link / 24-insider-case inventory / 0.444-magnitude article-vs-automated sign-reversal); 05-08 PhD slot: AEL (`2604.21725`, two-timescale Thompson-sampling retrieval-policy bandit, Sharpe 2.13±0.47); 05-08 daily slot: Per-Market ILS (`2605.02287`, 210k wallet-market pairs / 3.14% skilled). Next-PhD-slot lead: Heterogeneous Scientific Foundation Model Collaboration (`2604.27351`, ↑118, UIUC). Next-daily-slot lead: Interest-Bearing Long-Horizon (`2602.21091`, Maresca, Feb 24 2026, econ.GN, ~83% horizon-degradation elimination, Russia-Ukraine EoY-2026 hook).
...
- **`paper-pick` next slots** → PhD: **Heterogeneous Scientific Foundation Model Collaboration (`2604.27351`, ↑118, UIUC)** — promoted 05-08; backstop EvoScientist (`2603.08127`, ↑14). Daily: **Interest-Bearing Long-Horizon (`2602.21091`, Caleb Maresca, Feb 24 2026, econ.GN)** — promoted 05-11 after Galanis Information Aggregation picked same day daily slot; agent-based LLM-trader sim, interest-bearing positions eliminate ~83% of horizon-related accuracy degradation and lift participation 17%→62%; direct hook for the Russia-Ukraine EoY-2026 long-horizon market and broader long-horizon resolution-text question; would extend bench to 11-paper economics-and-trading. Backstop: Arbitrage Analysis in Polymarket NBA Markets (`2605.00864`, Cheng/Yang/Zou, Apr 22 2026), or first non-queued mission-axis paper from HF browse.
