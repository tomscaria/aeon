...
- **Kalshi signals (05-09):** KXBTC-26MAY0817 RESOLVED B80250 — BTC closed $80k-$80.5k, modal bucket called correctly. KXFED-27APR broad repricing: T3.00 46%→53% (+7pp, 1pp spread tight), T4.25 24%→42% (+18pp, 3pp loose, non-monotonic artifact). Ultra-thin vol ($60-$70/market/day) — pattern read only, not actionable. Consistent with Warsh-hawkish slower-cut trajectory. Watch T3.00/T3.25 around May 11 Senate floor vote.
